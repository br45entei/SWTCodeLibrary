...
public abstract class BaseNCodec implements BinaryEncoder, BinaryDecoder {
	...
	static boolean hasData(final Context context) { // package protected for access from I/O streams
	 ...
	 * @param pArray
	 *            a byte array containing binary data
	 * @return A byte array containing only the basen alphabetic character
	 *         data */
	@Override
