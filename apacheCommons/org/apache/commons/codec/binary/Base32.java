...
public class Base32 extends BaseNCodec {
	 ...
	 * from the "Base32 Alphabet" (as specified
	...
	/** This array is a lookup table that translates Unicode characters drawn
	 * from the "Base32 |Hex Alphabet" (as
	 * specified in Table 3 of RFC 4648) into their 5-bit positive integer
	 * equivalents. Characters that are not in the
	 * Base32 Hex alphabet but fall within the bounds of the array are
	 * translated to -1. */
	...
	*/
	 ...
	 *            8). If lineLength &lt;= 0, then the output will not be divided
	...
	void encode(final byte[] in, int inPos, final int inAvail, final Context context) {
		...
		if(inAvail < 0) {
			...
			final byte[] buffer = ensureBufferSize(this.encodeSize, context);
			final int savedPos = context.pos;
			switch(context.modulus) { // % 5
			case 0:
				break;
			case 1: // Only 1 octet; take top 5 bits then remainder
				buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 3) & MASK_5BITS]; // 8-1*5 = 3
				buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea << 2) & MASK_5BITS]; // 5-3=2
			...
			case 2: // 2 octets = 16 bits to use
				buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 11) & MASK_5BITS]; // 16-1*5 = 11
				buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 6) & MASK_5BITS]; // 16-2*5 = 6
				buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 1) & MASK_5BITS]; // 16-3*5 = 1
				buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea << 4) & MASK_5BITS]; // 5-1 = 4
				buffer[context.pos++] = this.pad;
				buffer[context.pos++] = this.pad;
				buffer[context.pos++] = this.pad;
				buffer[context.pos++] = this.pad;
			...
			case 3: // 3 octets = 24 bits to use
				buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 19) & MASK_5BITS]; // 24-1*5 = 19
				buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 14) & MASK_5BITS]; // 24-2*5 = 14
				buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 9) & MASK_5BITS]; // 24-3*5 = 9
				buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 4) & MASK_5BITS]; // 24-4*5 = 4
				buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea << 1) & MASK_5BITS]; // 5-4 = 1
				buffer[context.pos++] = this.pad;
				buffer[context.pos++] = this.pad;
				buffer[context.pos++] = this.pad;
				break;
			case 4: // 4 octets = 32 bits to use
				buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 27) & MASK_5BITS]; // 32-1*5 = 27
				buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 22) & MASK_5BITS]; // 32-2*5 = 22
				buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 17) & MASK_5BITS]; // 32-3*5 = 17
				buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 12) & MASK_5BITS]; // 32-4*5 = 12
				buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 7) & MASK_5BITS]; // 32-5*5 =  7
				buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 2) & MASK_5BITS]; // 32-6*5 =  2
				buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea << 3) & MASK_5BITS]; // 5-2 = 3
				buffer[context.pos++] = this.pad;
				break;
			default:
				throw new IllegalStateException("Impossible modulus " + context.modulus);
			...
			if(this.lineLength > 0 && context.currentLinePos > 0) { // add chunk separator if required
			...
			for(int i = 0; i < inAvail; i++) {
				...
				if(0 == context.modulus) { // we have enough bytes to create our output
					buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 35) & MASK_5BITS];
					buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 30) & MASK_5BITS];
					buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 25) & MASK_5BITS];
					buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 20) & MASK_5BITS];
					buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 15) & MASK_5BITS];
					buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 10) & MASK_5BITS];
					buffer[context.pos++] = this.encodeTable[(int) (context.lbitWorkArea >> 5) & MASK_5BITS];
					buffer[context.pos++] = this.encodeTable[(int) context.lbitWorkArea & MASK_5BITS];
