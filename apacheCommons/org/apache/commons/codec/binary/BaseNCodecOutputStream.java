...
public class BaseNCodecOutputStream extends FilterOutputStream {
	 ...
	 * @param basedCodec The BaseNCodec
	 * @param doEncode Whether or not to encode */
	 ...
	 * written out to the stream. If propagate is
	...
	private void flush(final boolean propagate) throws IOException {
		final int avail = BaseNCodec.available(this.context);
		if(avail > 0) {
			final byte[] buf = new byte[avail];
			final int c = BaseNCodec.readResults(buf, 0, avail, this.context);
			if(c > 0) {
