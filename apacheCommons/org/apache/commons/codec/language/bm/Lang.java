 ...
 * method instance().
 * Unless you are developing your own language guessing rules, you will not need
...
public class Lang {
	...
	protected static final class LangRule {
		private final boolean		acceptOnMatch;
		private final Set<String>	languages;
		private final Pattern		pattern;
		
		protected LangRule(final Pattern pattern, final Set<String> languages, final boolean acceptOnMatch) {
	 ...
	 * {@link #instance(NameType)} method.
	 * You will only need to call this yourself if you are developing custom
