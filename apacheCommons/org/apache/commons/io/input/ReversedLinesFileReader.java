...
public class ReversedLinesFileReader implements Closeable {
	...
	protected class FilePart {
		...
		protected FilePart(final long no, final int length, final byte[] leftOverOfLastFilePart) throws IOException {
			this.no = no;
		...
		private String readLine() throws IOException {
			...
			while(i > -1) {
				...
				// --- check for newline ---
				if((newLineMatchByteCount = getNewLineMatchByteCount(this.data, i)) > 0 /* found newline */) {
