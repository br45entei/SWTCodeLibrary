 ...
 * variables.
 * If a prefix and/or suffix for variables should be used other than the default
 * ones,
 ...
 * of
 * manually creating an instance. However if multiple replace operations are to
 * be
 ...
 * prefix
 * and suffix for variables which do not conflict with the result text you want
 * to
...
public class StrSubstitutor {
	...
	/** Variable resolution is delegated to an implementor of
	 * VariableResolver. */
	...
	private static final void checkCyclicSubstitution(final String varName, final List<String> priorVariables) {
	 ...
	 * delimite the
	 * variable name and the variable default value. This delimiter is expressed
	 * in terms of a matcher
	 ...
	 * becomes disabled.
	 *
	 * @param valueDelimiterMatcher variable default value delimiter matcher to
	 *            use, may be null
	 * @return this, to enable chaining
	 * @since 3.2 */
	 ...
	 *
	 * @param valueDelimiter the variable default value delimiter character to
	 *            use
	 * @return this, to enable chaining
	 * @since 3.2 */
	 ...
	 *
	 * @param valueDelimiter the variable default value delimiter string to use,
