 ...
 * specified,
 * and the formats supported by <code>java.text.MessageFormat</code> can be
 * overridden
 ...
 * whitespace
 * in the manner of <code>java.text.MessageFormat</code>. If <i>format-name</i>
 * denotes
 * <code>FormatFactory formatFactoryInstance</code> in <code>registry</code>, a
 * <code>Format</code>
 * matching <i>format-name</i> and <i>format-style</i> is requested from
 * <code>formatFactoryInstance</code>. If this is successful, the
 * <code>Format</code>
 ...
 * class to allow the type of customization which it is the job of this class to
 * provide in
...
public class ExtendedMessageFormat extends MessageFormat {
	...
	private static int readArgumentIndex(final String pattern, final ParsePosition pos) {
		final int start = pos.getIndex();
		seekNonWs(pattern, pos);
	...
	private static String parseFormatDescription(final String pattern, final ParsePosition pos) {
		final int start = pos.getIndex();
		seekNonWs(pattern, pos);
	 ...
	 * @return full pattern */
	private static String insertFormats(final String pattern, final ArrayList<String> customPatterns) {
	...
	private static void seekNonWs(final String pattern, final ParsePosition pos) {
		int len = 0;
	...
	private static ParsePosition next(final ParsePosition pos) {
	...
	private static StringBuilder appendQuotedString(final String pattern, final ParsePosition pos, final StringBuilder appendTo, final boolean escapingOn) {
		final int start = pos.getIndex();
		final char[] c = pattern.toCharArray();
	 ...
	 * @param pos current parse position
	 * @param escapingOn whether to process escaped quotes */
	private static void getQuotedString(final String pattern, final ParsePosition pos, final boolean escapingOn) {
	 ...
	 *         otherwise. */
	private static boolean containsElements(final Collection<?> coll) {
