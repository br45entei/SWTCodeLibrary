...
public class TypeUtils {
	 ...
	 * 
	 * @since 3.2 */
	protected static final class GenericArrayTypeImpl implements GenericArrayType {
		private final Type componentType;
		
		/** Constructor
		 * 
		 * @param componentType of this array type */
		protected GenericArrayTypeImpl(Type componentType) {
	...
	*/
	 ...
	 *            {@link WildcardType} or {@link TypeVariable}, not
	 *            {@code null}.
	...
	public static boolean containsTypeVariables(Type type) {
		...
		if(type instanceof WildcardType) {
			...
			return containsTypeVariables(TypeUtils.getImplicitLowerBounds(wild)[0]) || containsTypeVariables(TypeUtils.getImplicitUpperBounds(wild)[0]);
		}
		return false;
	}
	...
	private static boolean equals(WildcardType w, Type t) {
		if(t instanceof WildcardType) {
			...
			return equals(w.getLowerBounds(), other.getLowerBounds()) && equals(TypeUtils.getImplicitUpperBounds(w), TypeUtils.getImplicitUpperBounds(other));
		}
		return true;
	}
