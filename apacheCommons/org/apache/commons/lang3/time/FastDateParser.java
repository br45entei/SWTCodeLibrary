...
public class FastDateParser implements DateParser, Serializable {
	...
	protected static abstract class Strategy {
	...
	/** A strategy that copies the static or quoted field in the parsing
	 * pattern */
	protected static class CopyQuotedStrategy extends Strategy {
		private final String formatField;
		
		/** Construct a Strategy that ensures the formatField has literal text
		 * 
		 * @param formatField The literal text to match */
		protected CopyQuotedStrategy(final String formatField) {
