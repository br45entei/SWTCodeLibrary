 ...
 *
 * @since 3.0
 * @version $Id: MultiBackgroundInitializer.java 1583482 2014-03-31 22:54:57Z
 *          niallp $ */
public class MultiBackgroundInitializer extends BackgroundInitializer<MultiBackgroundInitializer.MultiBackgroundInitializerResults> {
	...
	public static class MultiBackgroundInitializerResults {
		...
		protected MultiBackgroundInitializerResults(final Map<String, BackgroundInitializer<?>> inits, final Map<String, Object> results, final Map<String, ConcurrentException> excepts) {
			initializers = inits;
			resultObjects = results;
			exceptions = excepts;
		}
		
		/** Returns the {@code BackgroundInitializer} with the given name. If
		 * the
		...
		/** Returns the {@code ConcurrentException} object that was thrown by
		 * the
